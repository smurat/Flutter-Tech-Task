...
abstract class _PokemonListModel implements PokemonListModel {
  const factory _PokemonListModel(
      ...
      final String? next,
      final String? previous,
      final List<Pokemon>? results}) = _$PokemonListModelImpl;
...
class _$PokemonImpl implements _Pokemon {
  const _$PokemonImpl({@HiveField(0) this.name, @HiveField(1) this.url});
...
abstract class _Pokemon implements Pokemon {
  const factory _Pokemon(
      ...
      @HiveField(1) final String? url}) = _$PokemonImpl;
